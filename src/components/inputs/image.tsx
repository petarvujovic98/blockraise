      ...
      render={({ field }) => (
        <FormItem>
          ...
          <div className="flex flex-row items-center justify-start gap-5">
            <div className="border-ui-elements-gray bg-ui-elements-light shadow-ui-elements-light relative flex h-20 w-20 items-center justify-center overflow-hidden rounded-full border shadow">
              {props.cid ? (
                <>
                  <Icon
                    name={props.label ?? ""}
                  ...
                  />
                  {uploading && (
                    <RefreshCcw04Svg className="animate-spin-counter absolute inset-0" />
                  )}
                </>
              ) : uploading ? (
                <RefreshCcw04Svg className="animate-spin-counter h-10 w-10" />
              ) : (
